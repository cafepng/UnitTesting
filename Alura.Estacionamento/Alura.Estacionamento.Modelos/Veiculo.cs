    ...
    public class Veiculo
    {
        ...
        public string Proprietario
        {
            ...
            set
            {
                if (value.Length < 3)
                {
                    throw new System.FormatException("Nome do proprietario inválido");
                }
        ...
        public void AlterarDados(Veiculo v)
        {
            this.Proprietario = v.Proprietario;
            this.Modelo = v.Modelo;
            this.Largura = v.Largura;
            this.Cor = v.Cor;
        }
        ...
        public override string ToString()
        {
            return $"Ficha do Veiculo:\n " +
                   ...
                   $"Proprietário: {this.Proprietario.ToString()}\n " +
                   $"Modelo: {this.Modelo}\n " +
                   $"Cor: {this.Cor}\n " +
                   $"Placa: {this.Placa}\n ";
        }
